...
const ComplaintForm = ({getComplaints}) => {
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      ...
      setRoom("");
      setDescription("");
      console.log("Name,room,descriptions is " + name + " "+ room + "description ");
      getComplaints();
      navigate("/dashboard");
      }
    } catch (err) {
  ...
  return (
    <>
      ...
      <div class="bg-gray-100 mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row-reverse lg:gap-10">
          <div class="max-w-2xl px-4 lg:pr-24">
            <p class="mb-2 text-blue-600 font-bold">HostelEase</p>
            <h3 class="mb-5 text-3xl font-semibold">Submit Your complaint</h3>
            <p class="mb-16 text-md text-gray-600">
              HostelEase  ensures a swift 
            ...
            <div class="mb-5 flex font-medium">
              ...
              <div class="">
                <p class="mb-2">Quick complaint resolution</p>
                <span class="font-normal text-gray-600">
                  Swift complaint resolution prioritizes timely and effective
  ...
  return (
    <>
      <div className="bg-gray-100 p-4 sm:p-8 md:p-10 h-screen">
        ...
        <ComplaintForm getComplaints={getComplaints}/>
      </div>
    </>
  );
};
